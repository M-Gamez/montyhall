...
#' `game` : the game with two doors with goats behind them and one with a car.
#' `a.pick`: the door selected by the contestant.
...
#' `stay`: Logical where `TRUE` returns contestants original choice and `FALSE` switches contestants choice to last remaining door.
#' `opened.door`: Number between 1-3 corresponding to goat door opened by host.
#' `a.pick`: Number between 1-3 corresponding to the original door selected by the contestant.
#' @return 
...
#' `final.pick`: Number between 1-3 corresponding to the contestants final choice after staying or switching.
#' `game` : the game with two doors with goats behind them and one with a car.
#' @return 
...
#' @param 
#' This function accepts two arguments:
#' `n`: a number corresponding to the number of games to be run.
#' @return 
#' @examples
#' @export
